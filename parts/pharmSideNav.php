    ...
    <div class="c-12 c-l-2 sidePanel">
        <div class="row account">
            ...
            <div class="c-7 name">
                ...
                <div class="usrBtns"><a href="../logout.php"><button type="button" class="btn btnNormal btnPatient" name="logout" id="logout"><i class="fas fa-sign-out-alt"></i> Logout</button></a></div>
            </div>
        </div>
